...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VALID_PAN = 3,                  /* VALID_PAN  */
  YYSYMBOL_4_n_ = 4,                       /* '\n'  */
  YYSYMBOL_YYACCEPT = 5,                   /* $accept  */
  YYSYMBOL_input = 6,                      /* input  */
  YYSYMBOL_PAN_VALIDATION = 7              /* PAN_VALIDATION  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VALID_PAN", "'\\n'",
  "$accept", "input", "PAN_VALIDATION", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* PAN_VALIDATION: VALID_PAN  */
#line 20 "pan.y"
              {
        if (isValidPAN) {
